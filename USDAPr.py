...
def function():
    ...
    for div_row in Headingrows:
        ...
        dateExtracted = div_row.find_element(By.XPATH, f"(//div[@class='news-release-date'])[{count}]").text # publishing date
        count += 1
        global final_date
...
RunDate= dt.today().strftime("%m/%d/%Y")
